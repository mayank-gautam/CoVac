...
public class EachDistrictActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_each_district);
        init();
        getAllValue();
    ...
    private void init() {
        tvConfirmed = findViewById(R.id.activity_eachDistrict_confirmed_textview);
        tvConfirmedNew = findViewById(R.id.activity_eachDistrict_confirmed_new_textview);

        tvActive = findViewById(R.id.activity_eachDistrict_active_textview);
        tvActiveNew = findViewById(R.id.activity_eachDistrict_active_new_textview);

        tvRecovered = findViewById(R.id.activity_eachDistrict_recovered_textview);
        tvRecoveredNew = findViewById(R.id.activity_eachDistrict_recovered_new_textview);

        tvDeath = findViewById(R.id.activity_eachDistrict_death_textview);
        tvDeathNew = findViewById(R.id.activity_eachDistrict_death_new_textview);
        pieChart = findViewById(R.id.pieChartEachDistrict);
